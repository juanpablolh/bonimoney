      ...
      <div className="flex flex-col space-y-6 lg:space-y-0 lg:grid lg:grid-cols-2 lg:gap-8 lg:items-start">
        ...
        <div className="space-y-6">
          ...
          <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
            <DialogContent className="sm:max-w-[440px] border-0 shadow-2xl rounded-[2rem] p-6 gap-0">
              <DialogHeader className="space-y-4">
                <DialogTitle className="text-[28px] font-serif font-medium tracking-tight text-neutral-900 text-left leading-tight">Cerrar grupo</DialogTitle>
          ...
          <Dialog open={deleteMemberDialogOpen} onOpenChange={setDeleteMemberDialogOpen}>
            <DialogContent className="sm:max-w-[440px] border-0 shadow-2xl rounded-[2rem] p-6 gap-0">
              <DialogHeader className="space-y-4">
                <DialogTitle className="text-[28px] font-serif font-medium tracking-tight text-neutral-900 text-left leading-tight">Eliminar integrante</DialogTitle>
                <DialogDescription className="text-neutral-500 font-medium text-left text-base leading-relaxed">
          ...
          <Dialog open={errorDialogOpen} onOpenChange={setErrorDialogOpen}>
            <DialogContent className="sm:max-w-[440px] border-0 shadow-2xl rounded-[2rem] p-6 gap-0">
              <DialogHeader className="space-y-4">
                <DialogTitle className="text-[28px] font-serif font-medium tracking-tight text-neutral-900 text-left leading-tight">No se puede eliminar</DialogTitle>
                <DialogDescription className="text-neutral-500 font-medium text-left text-base leading-relaxed">
                  {errorMessage}
                </DialogDescription>
              </DialogHeader>
