...
if (process.env.NODE_ENV !== "production") {
  FollowUpWorkOrder.propTypes = iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  ForLoop.propTypes = iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  FunnelSequence.propTypes = iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  FunnelSort.propTypes = iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  GlobalFilters.propTypes = iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  GraphAggregator.propTypes = iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  Heading.propTypes = iconPropTypes;
}
