...
const CouplingFacilityEncryption = /*#__PURE__*/React.forwardRef(function CouplingFacilityEncryption({
  children,
  size = 16,
  ...rest
}, ref) {
...
if (process.env.NODE_ENV !== "production") {
  CouplingFacilityEncryption.propTypes = iconPropTypes.iconPropTypes;
}
...
const DataSetEncryption = /*#__PURE__*/React.forwardRef(function DataSetEncryption({
  children,
  size = 16,
  ...rest
}, ref) {
...
if (process.env.NODE_ENV !== "production") {
  DataSetEncryption.propTypes = iconPropTypes.iconPropTypes;
}
...
exports.DataSetEncryption = DataSetEncryption;
