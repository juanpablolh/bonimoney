...
if (process.env.NODE_ENV !== "production") {
  ChildNode.propTypes = iconPropTypes.iconPropTypes;
}
...
const ClassicBatch = /*#__PURE__*/React.forwardRef(function ClassicBatch({
  children,
  size = 16,
  ...rest
}, ref) {
...
if (process.env.NODE_ENV !== "production") {
  ClassicBatch.propTypes = iconPropTypes.iconPropTypes;
}
...
if (process.env.NODE_ENV !== "production") {
  Comments.propTypes = iconPropTypes.iconPropTypes;
}
